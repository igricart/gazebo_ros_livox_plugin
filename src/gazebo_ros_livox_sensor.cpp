...
#include <gazebo_ros_ray_plugin/gazebo_ros_livox_sensor.h>

namespace gazebo
{

// Register this plugin with the simulator
GZ_REGISTER_SENSOR_PLUGIN(GazeboRosLivoxSensor)


////////////////////////////////////////////////////////////////////////////////
// Constructor
GazeboRosLivoxSensor::GazeboRosLivoxSensor()
{
}
...
////////////////////////////////////////////////////////////////////////////////
// Load the controller
void GazeboRosLivoxSensor::Load(sensors::SensorPtr _parent, sdf::ElementPtr _sdf)
{
...
std::string GazeboRosLivoxSensor::resolveTF(const std::string& _frame, const std::string& _robot_namespace, ros::NodeHandle& _nh)
{
  return _frame;
}

void GazeboRosLivoxSensor::SubscribeGazeboLaserScan()
{
  switch (this->output_type_)
  {
    case LASERSCAN:
      this->laser_scan_sub_ =
        this->gazebo_node_->Subscribe(this->parent_ray_sensor_->Topic(),
                                      &GazeboRosLivoxSensor::PublishLaserScan, this);
      break;
    case POINTCLOUD:
      this->laser_scan_sub_ =
        this->gazebo_node_->Subscribe(this->parent_ray_sensor_->Topic(),
                                      &GazeboRosLivoxSensor::PublishPointCloud, this);
      break;
    case POINTCLOUD2:
      this->laser_scan_sub_ =
        this->gazebo_node_->Subscribe(this->parent_ray_sensor_->Topic(),
                                      &GazeboRosLivoxSensor::PublishPointCloud2, this);
      break;
    case RANGE:
      this->laser_scan_sub_ =
        this->gazebo_node_->Subscribe(this->parent_ray_sensor_->Topic(),
                                     &GazeboRosLivoxSensor::PublishRange, this);
      break;
  }
}
...
////////////////////////////////////////////////////////////////////////////////
// Increment count
void GazeboRosLivoxSensor::LaserConnect()
{
...
////////////////////////////////////////////////////////////////////////////////
// Decrement count
void GazeboRosLivoxSensor::LaserDisconnect()
{
  this->laser_connect_count_--;
...
void GazeboRosLivoxSensor::PublishLaserScan(ConstLaserScanStampedPtr &_msg)
{
...
void GazeboRosLivoxSensor::PublishPointCloud(ConstLaserScanStampedPtr &_msg)
{
...
void GazeboRosLivoxSensor::PublishRange(ConstLaserScanStampedPtr &_msg)
{
